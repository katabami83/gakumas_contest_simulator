export const data = [
  ...
  },
  {
    ...
    type: 'active',
    plan: 'anomaly',
    cost: { type: 'status', target: '全力値', value: -2 },
    condition: '',
    effects: [
      { type: 'status', target: '指針', value: 3 },
      { type: 'score', value: 6 },
  ...
  },
  {
    ...
    type: 'active',
    plan: 'anomaly',
    cost: { type: 'status', target: '全力値', value: -1 },
    condition: '',
    effects: [
      { type: 'status', target: '指針', value: 3 },
      { type: 'score', value: 8 },
  ...
  },
  {
    ...
    effects: [
      { type: 'status', target: '全力値', value: 2 },
      { type: 'retain', target: '山札捨札', value: 1 },
      { type: 'status', target: 'スキルカード使用数追加', value: 1 },
      { type: 'status', target: '指針固定', value: 1 },
    ],
    limit: 1,
    card_cost: 105,
    allow_duplicate: false,
  ...
  //  ## ##    ## ##   #### ##           ###  ##  ###  ##   ## ##   ##   ##  ###  ##  ### ###    ##              ##   ##  ### ###  ###  ##
  {
    ...
    type: 'mental',
    plan: 'anomaly',
    cost: { type: 'status', target: '全力値', value: -3 },
    condition: '',
    effects: [
      { type: 'status', target: 'スキルカード使用数追加', value: 1 },
  ...
  },
  {
    ...
    condition: '',
    effects: [
      { type: 'reinforcement', target: 'すべてのパラメータ値増加', value: 6 },
      {
        type: 'status',
        target:
          '以降、ターン開始時、いずれかの指針の場合、すべてのスキルカードのパラメータ値増加+4',
  ...
  },
  {
    ...
    effects: [
      { type: 'genki', value: 8 },
      { type: 'status', target: '全力値', value: 7 },
      { type: 'retain', target: '山札捨札', value: 1 },
    ],
    limit: 1,
    card_cost: 204,
  ...
  },
  {
    ...
    effects: [
      { type: 'status', target: '指針', value: 2 },
      { type: 'reinforcement', target: 'スターライトのパラメータ上昇回数増加', value: 1 },
      { type: 'move', target: '2013021', value: 1 },
      { type: 'status', target: 'スキルカード使用数追加', value: 1 },
    ],
    limit: 1,
    card_cost: 0,
  ...
  },
  {
    ...
    plan: 'anomaly',
    cost: { type: 'hp', value: -2 },
    condition: 'total_fullpower>=1',
    growths: [
      {
        trigger: 'change_guideline',
        condition: '指針==5',
        effects: [{ type: 'add_score_times', value: 1 }],
        limit: 4,
      },
    ],
    effects: [{ type: 'score', value: 25 }],
    ...
    effects: [
      {
        type: 'score',
        value: 0,
        options: [{ type: 'increase_by_percentage', target: '好調', value: 150 }],
      },
      { type: 'status', target: '好調', value: 3 },
      { type: 'status', target: 'スキルカード使用数追加', value: 1 },
    ],
